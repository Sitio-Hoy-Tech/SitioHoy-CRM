  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
        <Link
          href="/contactos"
          className="bg-[--bg-card] rounded-xl border border-[--border-primary] p-6 hover:border-[--accent-border] transition-all duration-300 group"
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-sm text-[--text-muted] font-medium">Contactos</p>
              <p className="text-3xl font-bold text-[--text-primary] mt-1">{totalContactos.toLocaleString("es-AR")}</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-3xl font-bold text-[--text-primary] mt-1">{totalClientes.toLocaleString("es-AR")}</p>
            </div>
          </div>
        </Link>
      </div>

      <h2 className="text-base font-semibold text-[--text-primary] mb-3">Accesos rápidos</h2>
