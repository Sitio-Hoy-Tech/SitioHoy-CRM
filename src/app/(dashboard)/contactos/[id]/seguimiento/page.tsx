...
export default function SeguimientoPage() {
  ...
  return (
    <div className="max-w-4xl animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-edge p-6 mb-8">
        <h2 className="text-sm font-semibold text-heading mb-4">Agregar nota de seguimiento</h2>
      ...
      <h2 className="text-sm font-semibold text-heading mb-4">Historial</h2>

      {seguimientos.length === 0 ? (
        <div className="bg-card rounded-xl border border-edge p-6 text-center text-muted text-sm">
          ...
          {seguimientos.map((s) => (
            <div key={s.id} className="flex gap-4 pb-6">
              ...
              <div className="flex-1 pb-2">
                ...
                <p className="text-sm text-body whitespace-pre-wrap">{s.notas}</p>
              </div>
            </div>
          ))}
        </div>
